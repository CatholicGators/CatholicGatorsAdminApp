...
import {
    googleSignIn,
    signOut,
} from "../../modules/auth/redux/actions/authActions"
                ...
                <AppBar position="static">
                    <Toolbar className={classes ? classes.toolbar : null}>
                        ...
                        <Typography
                            variant="h6"
                            color="inherit"
                            className={classes ? classes.grow : null}
                        >
                            Catholic Gators Admin
                        </Typography>
                        <div
                            className={
                                classes ? classes.desktopMenuItems : null
                            }
                        >
                            {user
                                ? menuLinks
