...
describe("contactFormEpics", () => {
    ...
    describe("getAllContactsEpic", () => {
        ...
        it("emits SUBMIT_CONTACT_FORM_ERR when contactFormService.getAllContacts() returns an error", (done) => {
            const err = "test";
    ...
    describe("updateContactStatusEpic", () => {
        ...
        it("emits SUBMIT_CONTACT_FORM_ERR when contactFormService.updateContactStatus() returns an error", (done) => {
            const err = "test";
